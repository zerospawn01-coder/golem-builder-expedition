...
- `GOLEM-EXPEDITION-LIVE-LOOP-01`
  ...
  - Status: `D0 PASS / OPTION B APPROVED`; D1 contract and D2 deterministic vectors are `FROZEN / PASS`; E3 implementation remains `HOLD / NOT AUTHORIZED` pending an explicit start decision.
